...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ...
      {...props}
    >
      {/* Hover cue inside the radio when the parent label has `group` and is hovered */}
      <span className="pointer-events-none absolute inset-[3px] rounded-full bg-[#224BFF]/20 opacity-0 transition-opacity duration-150 group-hover:opacity-100" />
