          ...
          >
            <div className="flex flex-col gap-9">
              <div className="flex flex-col gap-8">
                <h1 className="text-black text-4xl font-bold font-[Arial]">
                  Forgot Password
                </h1>
                <p className="text-black text-base font-normal font-[Arial] leading-6">
                  Please select a new password for your purchase. Your PROClub
              ...
              <div className="flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                  ...
                  <div
                    className={`h-11 px-3 py-6 border rounded bg-white flex items-center gap-3 ${email ? (emailValid ? "border-green-500" : "border-red-500") : "border-black"}`}
                  >
                    <input
                      type="email"
                      value={email}
